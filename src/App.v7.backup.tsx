          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3 shrink-0 w-full md:w-auto justify-end">
              ...
              <button
                ...
                className={`px-2.5 py-2 rounded-lg border transition-all shrink-0 flex items-center gap-1.5 cursor-pointer ${
                  userApiKey 
                    ? "bg-emerald-950/20 border-emerald-500/20 text-emerald-400 hover:bg-emerald-950/40" 
                    : "bg-zinc-950 hover:bg-zinc-900 border-white/[0.08] text-zinc-400 hover:text-white"
                }`}
                title="Configure, clear, or update your saved Gemini API key"
              >
                <Key size={11} className={userApiKey ? "text-emerald-400" : "text-amber-500"} />
